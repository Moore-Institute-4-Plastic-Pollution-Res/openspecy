                                   ...
                                   box(
                                       ...
                                       fluidRow(
                                           box(
                                               width = 12,
                                               footer = tags$small(
                                                   "Signal thresholding technique, value, and histogram threshold plot. If turned on, the threshold will be applied to any batch analysis results and values lower than the minimum will appear blacked out. 'Signal Over Noise' divides the highest peak by a low region. 'Signal Times Noise' multiplies the mean intensity by the standard deviation. 'Total Signal' is the sum of signal intensities. The line on the histogram plot is the threshold being used."
                                               ),
                                               title = prettySwitch(
                                                   "threshold_decision",
                                       ...
                                       fluidRow(
                                           box(
                                               ...
                                               collapsed = T,
                                               footer = tags$small(
                                                   "Options for showing collapsed versions of identification.
                                               ...
                                               pickerInput(
                                                   inputId = "collapse_log_type",
                                                   label =  "Particle Region Logic",
                                       ...
                                       fluidRow(
                                           box(
                                               ...
                                               collapsed = T,
                                               footer = tags$small(
                                                   "Spatial Gaussian smoothing of hyperspectral images can reduce background noise and improve image analysis.
