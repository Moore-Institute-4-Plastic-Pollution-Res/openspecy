          ...
          accordionItem(
            ...
            fluidRow(
              column(6,
                     ...
                     br(),
                     p(class = "lead", 
                       HTML("Looking for the classic version of OpenSpecy? Go to <a href='https://wincowger.shinyapps.io/openspecy-classic'>wincowger.shinyapps.io/openspecy-classic</a>"))),
              column(6, HTML("<iframe width='100%' height='100%' src='https://www.youtube-nocookie.com/embed/3RKufDxzriE' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen require-corp credentialless (Chrome > 96)></iframe>")
              )
            )
          )
        ),
